...
int Cli::handleAdd(const std::vector<std::string>& args, bool allowPrompts) const
{
  if (args.size() <= 1)
    allowPrompts = true;
...
int Cli::handleEdit(const std::vector<std::string>& args, bool allowPrompts) const
{
